...
*/
  ...
  $events[$when] = array ('url'=>'', 'hour'=>$r->hour, 'minute'=>$r-minute, 'place'=>$r->place, 'nick'=>$nick, 'number'=>$r->number, 'title'=>$r->title, 'inscr'=>$inscr);
   }
  }
  /*echo "</ul>";*/
...
*/
 ...
 /* if ($when >= $now) */
   ...
   {
   if ($event['url'] == '')
    echo "<p><li> " . $event['hour'] . ":" . $event['minute'] . " " . $event['place'] . " " . $event['nick'] . " <a href=event.php?number=" . $event['number'] . ">" . $event['title'] . "</a> sur ce site - " . $event['inscr'];
   else
    echo "<p><li> " . $event['hour'] . ":" . $event['minute'] . " " . $event['place'] . " " . $event['nick'] . " <a href=remote_event.php?url=" . $event['url'] . "&number=" . $event['number'] . ">" . $event['title'] . "</a> sur " . $event['url']; 
   }
   }
  }
  echo "</ul>";
